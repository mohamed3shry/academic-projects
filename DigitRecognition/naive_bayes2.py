...
logger = get_logger(log_dir="results", log_file="naive_bayes2.log")
logger.info("Starting Multinomial Naive Bayes training...")
...
final_model.fit(X, y)
joblib.dump(final_model, "results/naive_bayes2.pkl")
logger.info("Final model saved to results/naive_bayes2.pkl")
...
plt.ylabel("True")
plt.savefig("results/naive_bayes2_confusion.png")
plt.show()
